<?php
session_start();
if(isset($_SESSION["LogMe"]) && $_SERVER["HTTP_REFERER"] = "http://localhost/eSHOP/manageUser/login.php"){
	unset($_SESSION["LogMe"]);
}
$email =$name= "";
...
<link href="bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <body class="goto-here">
    		...
    		<div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class=" col-md pr-4 d-flex topper align-items-center search-box input-group">
   ...
   <div class="input-group">
	...
	<input type="text" class="form-control my-0 py-1 lime-border search_ba" placeholder="Search" aria-label="Search" name="search_engin" autocomplete="off" id="search">
  
	
	<span class="input-group-btn">
		<button class="btn btn-primary set-btn search_ba" name="submit_search">
...
<div class="result"></div>
						...
						<?php if(!isset($_SESSION["name"])){ echo '<span class="text"><a class="btn btn-success btn-sm" href="manageUser/login.php"><i class="fa fa-lock"></i>LOG IN</a></span>';}else{ echo "<span class='text'><a class='btn btn-success btn-sm' href='manageUser/logout.php'>Log out</a></span>";} ?>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">eSHOP<span style="text-decoration: blue;">.</span></a>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third order-md-last img-fluid" src="images/women4.jpg" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">#New Arrival</span>
		          		<div class="horizontal">
				            <h1 class="mb-4 mt-3">Shoes 2019</h1>
				            <p class="mb-4">A small river named Duden flows by their place.</p>
...
$(document).ready(function(e){
        ...
        $("#search_param").attr("value",concept);
		   	});

			   $(".search_ba").on("keyup input", function(){

    		...
    		<div class="row no-gutters d-flex align-items-start align-items-center px-md-0">
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
						...
						<?php if(!isset($_SESSION["name"])){ echo "<span class='text'><a class='btn btn-success btn-sm' href='manageUser/login.php'>Sign in</a></span>";}else{ echo "<span class='text'><a class='btn btn-success btn-sm' href='manageUser/logout.php'>Log out</a></span>";} ?>
					    </div>
				    </div>
			    </div>
		    </div>
...
<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product">
    					<a   href="product-single.php?id=<?=$record['id']?>" class="img-prod"><img class="img-fluid" src="<?php echo 'imagess/'.$record["photo"]; ?>" alt="Colorlib Template">
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3">
    						...
    						<h3><a href="#">Nike Free RN 2019 iD</a></h3>
  							<div class="pricing">
	    						<p class="price"><span><?php echo "$".$record["id"]."00"; ?></span></p>
	    					</div>
...
<?php } ?>
  ...
  <?php
    ...
    <div class="card">
      ...
      <div id="<?php echo 'collapse'.$cat; ?>" class="collapse show" data-parent="#accordion">
        <div class="card-body">
    ...
    <div class="card">
      ...
      <div id="<?php echo 'collapse'.'Four' ?>" class="collapse" data-parent="#accordion">
        <div class="card-body">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
        </div>
      </div>

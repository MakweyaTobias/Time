...
$shop_id = $_SESSION["shop_id"];
                                ...
                                if($result =mysqli_query($conn,$sql)){
                                    $catTotal = mysqli_num_rows($result);
                                }
                                ...
                                if($result =mysqli_query($conn,$sql)){
                                    $prodTotal = mysqli_num_rows($result);
                                }
                                ?>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <form role="search" class="app-search hidden-sm hidden-xs m-r-10">
                            <input type="text" placeholder="<?php echo $_SESSION["shopNam"]; ?>" class="form-control"> 
                            <a href="">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="category.php" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Categories</a>
                    </li>
                    <li>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-success"></i> <span class="counter text-success"><?php echo $catTotal; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple"><?php echo $prodTotal; ?></span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Pages Visitor</h3>
                            <ul class="list-inline two-part">
                                <li>

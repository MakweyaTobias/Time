...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="home.php">Minishop</a>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row">
				...
				<a   class="img-prod"><img class="img-fluid" src="<?php echo "imagess/".$record["photo"]; ?>" alt="Colorlib Template">
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price"><span><?php echo "$".$record["price"]; ?></span></p>
